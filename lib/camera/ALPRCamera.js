 ...
 */
export const ALPRCamera = ({ OnPlateRecognized, OnCallLimitReached, OnPictureTaken, callLimit, defaultFilter, children, takePictureButtonStyle, takePictureButtonTextStyle, }) => {
    ...
    */
     ...
     */
    const findPlatesAndVerify = Worklets.createRunInJsFn((ocrFrame) => {
        ...
        if (ocrResult !== null) {
            ...
            callLimiter(ocrResult, callLimit || 0, (result) => {
                if (result !== null) {
    ...
    return (<View style={{ flex: 1 }}>
      <Camera ref={camera} style={StyleSheet.absoluteFill} device={device} isActive={true} frameProcessor={frameProcessor} photo={true}/>
      {/* Additional children */}
      {children}
      ...
      <TouchableOpacity onPress={takePicture} style={takePictureButtonStyle}></TouchableOpacity>

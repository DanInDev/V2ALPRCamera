import { filterWithMultipleOptions, findBlockWithHighestX, } from '../../src/filtering/filterService';
import { GENERAL, DK, } from '../../src/filtering/filterOptions';
describe('filterWithMultipleOptions function', () => {
    ...
    it('should return filtered blocks with the scandinavian collection filter, one motorcycle licenseplate.', () => {
        ...
        const filteredBlocks = filterWithMultipleOptions(mockOCRFrame, DK);
    ...
    it('should return filtered blocks with the general filter, three different licenseplates', () => {
        const filteredBlocks = filterWithMultipleOptions(mockOCRFrame, GENERAL);
